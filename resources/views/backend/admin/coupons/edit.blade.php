                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            ...
                            <li class="breadcrumb-item active">Coupons Edit
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <section class="users-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-validate" action="{{ route('admin.coupons.update',['coupon'=>$coupon->id]) }}" method="POST">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="form-group row"  id="discounted_amount">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" step="any"
                                            ...
                                            max="99999999" name="amount" required
                                            oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="d-flex date col-sm-6">
                                        ...
                                        <input type="date" id="datePickerId" class="form-control"  placeholder="Enter Name"  name="start_date" value="{{$coupon->start_date ?? old('start_date')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label require"
                                    ...
                                    <div class="d-flex date col-sm-6">
                                        ...
                                        <input type="date" id="datePickerId" class="form-control"  placeholder="Enter Name"  name="end_date" value="{{$coupon->end_date ?? old('end_date')}}">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-between w-100">
                                    <button type="submit" class="btn btn-primary glow ">Edit</button>
                            </div>
                        </div>
