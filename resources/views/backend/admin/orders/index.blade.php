                                    ...
                                    <tbody>
                                     @foreach ($list as $item)
                                         <tr>
                                            ...
                                            <td>{{$item->id}}</td>
                                            <td>{{$item->getdeliveryaddress ? $item->getdeliveryaddress->fname." ".$item->getdeliveryaddress->lname : ''}}</td>
                                            <td>{{$item->getdeliveryaddress ? $item->getdeliveryaddress->email : '' }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.order.destroy', ['orders'=>$item->id]) }}"  onclick="return confirm('Are You Sure To Delete This  ?')"><i
