        ...
        <ol class="inline-flex flex-wrap items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="https://livsham.softwarebyte.co/product/category?category={{ $subsub_category[0]->getsubcategory->getcategory->id }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $subsub_category[0]->getsubcategory->getcategory->name }}</a>
            </div>
          </li>
          <li aria-current="page">
            <div class="flex items-center">
              <svg aria-hidden="true" class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
              <a href="https://livsham.softwarebyte.co/product/sub_cat/{{ $subsub_category[0]->getsubcategory->id }}" class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $subsub_category[0]->getsubcategory->name }}</a>
            </div>
          </li>
        </ol>
      </div>
    ...
    <section class="card-filter overflow-hidden mx-1">
        <div class="max-w-7xl mx-auto">
            <div class="row">
                ...
                <div id="subsub-category" class=" row  mx-auto">
                     
                   @foreach ($product as $item)
                     
                    <div class="card-box col-6 col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-6 px-1 py-3">
