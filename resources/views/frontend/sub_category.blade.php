        ...
        <ol class="inline-flex flex-wrap items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <a href="https://livsham.softwarebyte.co/product/category?category={{ $sub_category[0]->getcategory->id }}" class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $sub_category[0]->getcategory->name }}</a>
            </div>
          </li>
          @endif
        </ol>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="row">
                ...
                <div id="sub-category" class="row col-12 col-lg-9 mx-auto">
                    ...
                    <div class="card-box col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 px-1 py-3">
