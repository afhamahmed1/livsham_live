    ...
    <div class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex flex-wrap items-center space-x-1 md:space-x-3">
          <li class="inline-flex items-center">
            <a href="https://livsham.softwarebyte.co/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
...
<div class="fixed-product-bg bg-black fixed h-[100vh] top-0 left-0 right-0 opacity-70 z-40 hidden" id="product_bg">
 ...
 <div class="max-w-7xl mx-auto mb-12">
       ...
       <div class="all-products w-full flex flex-row sm:space-x-4 px-2">
