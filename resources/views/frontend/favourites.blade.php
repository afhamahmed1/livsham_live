...
@section('content')
   ...
   <section class="col-lg-11 mx-auto">
    <div class="my-favourite w-full max-w-7xl mx-auto px-3">
        <div class="row">
            <div class="favourite">
                <h3>Mina Favoriter <span>({{ $favourite_products->count() }})</span></h3>
            </div>
        </div>
    </div>
</section>
  ...
  <section class="livshem-cards col-lg-11 mx-auto">
        <div class="home-cards w-full max-w-7xl mx-auto p-1">
            
            <div class="container">
                <!--<h1 style="font-size: 28px; line-height: 36.4px;">Mina favoritprodukter</h1>-->
                <div class="row">
                     @foreach ($favourite_products as $item)
                    ...
                    <div class="card-box col-6 col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-6 px-1 py-3">
                        <div class="card h-100" id="{{$item->id}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="price">
                                    <span>
                                        <h4>{{$item->getcategory->name}}</h4>
                                        <h4 class="text-[10px]">Price Per Item:{{$item->price_per_item}}</h4>
                                    </span>
                                ...
                                <div class="card-counter-div card-counter d-flex">
                                    <a class="card-minus-div hidden"><i class="bi bi-dash-circle-fill minus"></i></a>
                                    <input type="number" class="st  hidden card-quantity-div" value="0" size="2">
                                    <a class="card-plus-div  hidden"><i class="bi bi-plus-circle-fill plus"></i></a>
